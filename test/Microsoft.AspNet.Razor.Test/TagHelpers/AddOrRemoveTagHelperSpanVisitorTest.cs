...
namespace Microsoft.AspNet.Razor.TagHelpers
{
    public class AddOrRemoveTagHelperSpanVisitorTest
    {
        ...
        public void GetDescriptors_LocatesTagHelperCodeGenerator_CreatesDirectiveDescriptors()
        {
            ...
            {
                new TagHelperDirectiveDescriptor { DirectiveType = TagHelperDirectiveType.AddTagHelper, LookupText = "one" },
                new TagHelperDirectiveDescriptor { DirectiveType = TagHelperDirectiveType.RemoveTagHelper, LookupText = "two" },
                new TagHelperDirectiveDescriptor { DirectiveType = TagHelperDirectiveType.RemoveTagHelper, LookupText = "three" },
            };
        ...
        private class TagHelperDirectiveDescriptorComparer : IEqualityComparer<TagHelperDirectiveDescriptor>
        {
            ...
            {
                return directiveDescriptorX.LookupText.Equals(
                            directiveDescriptorY.LookupText, StringComparison.Ordinal) &&
